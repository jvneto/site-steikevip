...
export const redeemRequest = (email, cpf) =>
  request("/public/redeem/request", { method: "POST", body: { email, cpf } });

export const redeemConfirm = (email, cpf, code) =>
  request("/public/redeem/confirm", { method: "POST", body: { email, cpf, code } });
