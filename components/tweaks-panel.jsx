...
const __TWEAKS_STYLE = `
  ...
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483645;
    width:36px;height:36px;border-radius:10px;border:.5px solid rgba(255,255,255,.6);
    background:rgba(250,249,247,.78);backdrop-filter:blur(24px);cursor:pointer;
    display:grid;place-items:center;font-size:16px;color:#29261b;
